...
class AgeDB(data.Dataset):
    ...
    def __change_number(self):
        ...
        for i,l in enumerate(self.labels):
            fls +=[self.files[i],]*count[int(l*10)]
        self.files = fls
    ...
    def get_box_params(self, file, src="/home/raman/Work/big/scoring_data/drilling/all_json/"):
        data = json.load(open(src + file, 'r'))
    ...
    def get_homographic_transformation(self, file, side = 300):
        ...
        box, h, w = self.get_box_params(file.replace(".png", ".json").split("/")[-1])
