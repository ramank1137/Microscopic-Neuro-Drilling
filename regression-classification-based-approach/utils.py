...
def prepare_folders(args):
    folders_util = [args.store_root, os.path.join(args.store_root, args.exp), os.path.join(args.store_root, args.exp, args.store_name)]
...
def save_checkpoint(args, state, is_best, prefix=''):
    filename = f"{args.store_root}/{args.exp}/{args.store_name}/{prefix}ckpt.pth.tar"
